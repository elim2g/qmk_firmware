...
// Based off "improved hhkb layout", but with eLim's personal preferences on layers
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LGUI, KC_LGUI, KC_LGUI,                   KC_SPACE,                 KC_RALT, KC_RALT, KC_RALT
      ),
  ...
  [1] = LAYOUT(
      ...
      KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT, KC_MPLY, KC_MSTP, KC_ASTR, KC_SLSH, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, KC_TRNS,
  ...
  [2] = LAYOUT(
      KC_ESC,  KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,    KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_INS, RESET,
      KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP,  KC_PGDN, KC_TRNS,  KC_HOME, KC_END,  KC_TRNS, KC_DEL,
      KC_TRNS, KC_LT,   KC_GT,   KC_TRNS,  KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, KC_TRNS, KC_TRNS, KC_TRNS,
